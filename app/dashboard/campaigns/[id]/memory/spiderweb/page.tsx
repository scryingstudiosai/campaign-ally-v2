...
export default async function SpiderwebPage({ params }: PageProps) {
  ...
  // Fetch all relationships for this campaign (DM sees ALL relationships)
  ...
  // Debug: Log relationship count
  console.log('[SpiderwebPage] Loaded relationships:', relationships?.length, 'for campaign:', params.id)
